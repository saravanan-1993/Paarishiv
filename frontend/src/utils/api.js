...
export const hrmsAPI = {
    ...
    processPayroll: (data) => api.put('/hrms/payroll/process', data),
...
export const inventoryAPI = {
    ...
    reconcileTransfers: () => api.post('/inventory/transfers/reconcile'),
...
export const labourAttendanceAPI = {
    ...
    requestPayment: (id) => api.put(`/labour-attendance/${id}/request-payment`),
    approvePayment: (id) => api.put(`/labour-attendance/${id}/approve-payment`),
    rejectPayment: (id, data) => api.put(`/labour-attendance/${id}/reject-payment`, data),
