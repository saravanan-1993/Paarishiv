...
async def seed_admin_only():
    ...
    admin_role = {
        ...
        "permissions": [
            ...
            {"name": "Projects", "actions": {"view": True, "add": True, "edit": True, "delete": True}, "subTabs": ["Overview", "Tasks", "DPR", "Financials", "Documents", "Labour Attendance", "Workflow Tracking"]},
            ...
            {"name": "Fleet Management", "actions": {"view": True, "add": True, "edit": True, "delete": True}, "subTabs": ["Dashboard", "Trips", "Vehicles", "Maintenance", "Reports"]},
            {"name": "System Logs", "actions": {"view": True, "add": True, "edit": True, "delete": True}},
            {"name": "Settings", "actions": {"view": True, "add": True, "edit": True, "delete": True}, "subTabs": ["Profile", "Company Profile", "Security", "Notifications", "Cloudinary", "SMTP"]},
            {"name": "Site Reports", "actions": {"view": True, "add": True, "edit": True, "delete": True}, "subTabs": ["Site Reports (DPR)", "Material Requests", "Transfer Requests"]},
            {"name": "Subcontractor Billing", "actions": {"view": True, "add": True, "edit": True, "delete": True}},
            {"name": "Notifications", "actions": {"view": True, "add": True, "edit": True, "delete": False}},
        ],
